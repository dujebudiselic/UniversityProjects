	.file	"Polimorfizam_tijekom_konstruiranja_objekta.cpp"
...
LFB13:
	...
	# 3. U konstruktoru Base se postavlja pokazivač na virtualnu tablicu te se poziva metoda što 
	# 3. uzrukuje prvi ispis "Metoda kaze: ja sam bazna implementacija!" zatim se vraćamo na konstruktor Derived: 
...
LFB19:
	...
	# 4. Postavlja se pokazivač na virtualnu tablicu za Derived te se poziva metoda 
	# 4. što uzrukuje drugi ispis "Metoda kaze: ja sam izvedena implementacija!".
...
LFB21:
	...
	# 1. Prateći strojni kod prvo se u main izvršava "Derived* pd=new Derived();":
	mov	DWORD PTR [esp], 4
LEHB0:
	call	__Znwj
LEHE0:
...
LEHE1:
	...
	# 5. Zatim se u main ponovno poziva metoda, a kako je postavljen pokazivač na virtualnu tablicu 
	# 5. ispisat će se zadnji "Metoda kaze: ja sam izvedena implementacija!":
